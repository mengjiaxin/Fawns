 ...
 * {@link com.android.volley.toolbox.ImageLoader#getImageListener(ImageView, int, int)}. Note that all function calls to
...
public class ImageLoader {
    ...
    /**
     * Equivalent to calling {@link #get(String, com.android.volley.toolbox.ImageLoader.ImageListener, int, int, ScaleType)} with
